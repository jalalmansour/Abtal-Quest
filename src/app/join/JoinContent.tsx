...
// No metadata export in the client component

export default function JoinContent() {
    // All the JSX and logic from the original JoinPage goes here
    return (
        <> {/* Use a Fragment because PageLayout will wrap this */}
            {/* Hero Section */}
