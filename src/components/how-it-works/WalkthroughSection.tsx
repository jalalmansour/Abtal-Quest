  ...
  return (
    <section className="section-padding" id="walkthrough-section">
      <div className="container-custom">
        ...
        <Tabs defaultValue="garden" className="w-full max-w-5xl mx-auto">
          <div className="flex justify-center mb-12" data-aos="fade-up">
            <TabsList className="grid sm:grid-cols-2 md:grid-cols-4 gap-2">
              <TabsTrigger value="garden" className="text-base py-3 flex flex-col items-center">
                <Garden className="mb-1 h-5 w-5" />
                <span>VIP Garden</span>
              </TabsTrigger>
          ...
          <TabsContent value="garden">
            <TabContent
              title="The VIP Garden: Mindset Development"
              description="The VIP Garden is a special virtual space where children develop the mental frameworks and mindset needed for real-world resilience. Here, kids engage with interactive content that teaches them how to approach challenges with a growth mindset."
              icon={<Garden className="h-8 w-8 text-orange-500" />}
              content={
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-border/50 p-6 card-3d">
                  ...
                  <div className="bg-white dark:bg-gray-700 border border-border/50 rounded-lg p-4 mb-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm">VIP Garden Completion</span>
